              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    We are building new celestial e-Commerce solutions for businesses to connect with their users and deliver value in the super-Digital web space. WooCommerce significantly enhances the UX/UI of an e-Commerce website and is a simple plugin that is shaping the future of e-Commerce.</p>
                  </div>
