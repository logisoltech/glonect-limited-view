                ...
                <div className="space-y-8">
                  <div>
                    <h2 className="text-white text-3xl lg:text-5xl font-bold leading-tight mb-6">
                      Strategic Planning Blended With{' '}
                      <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                        Creative Storytelling!
                      </span>
                    </h2>
                    <p className="text-gray-300 text-lg leading-relaxed">
                    We have expanded our galactic realm of creative and forward-thinking marketing and branding strategies to give strong voices to brands. Our custom branding services follow our super-Digital concept that focuses on brand development in both early-stage and late-stage business cycles.
                    </p>
                  </div>
            ...
            <div className="max-w-7xl mx-auto px-8">
              ...
              <div className="text-center mb-16">
                <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6">
                  Branding <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Packages</span>
                </h2>
