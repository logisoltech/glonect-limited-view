              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    We are empowering the super-Digital planet with custom magento website and store development services, delivering features to build and optimize multichannel e-commerce stores. We help mid-sized and large-scale businesses deliver enriching shopping experiences to smart customers across the globe.                    </p>
                  </div>
