            ...
            <div className="max-w-7xl mx-auto px-8">
              ...
              <div className="text-center mb-16">
                <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6">
                  Ecommerce <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Packages</span>
                </h2>
                <p className="text-gray-300 text-xl max-w-3xl mx-auto">
                  Choose the perfect ecommerce package for your online business. All packages come with our 100% satisfaction guarantee.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Advanced ecommerce solution for growing businesses with comprehensive features and marketing tools.",
                    price: "$6,999",
                  ...
                  },
                  {
                    ...
                    description: "Fully customized ecommerce platform tailored to your specific business needs and requirements.",
                    price: "$4,999",
                    originalPrice: "$7,999",
                    features: [
                      "Unlimited Products",
