              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    Powerful, engaging, intuitive and secure web applications.
                    </p>
                  </div>
            ...
            <div className="max-w-7xl mx-auto px-8">
              ...
              <div className="text-center mb-16">
                <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6">
                  Website Development <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Packages</span>
                </h2>
                <p className="text-gray-300 text-xl max-w-3xl mx-auto">
                  Choose the perfect website development package for your business needs. All packages come with our 100% satisfaction guarantee.
                </p>
              </div>
