              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    Giving your visual dream{' '}
                      <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                      an impactful design.
                      </span>
                    </h2>
                    <p className="text-gray-300 text-lg leading-relaxed">
                    Our creative junkies feed on stories to introduce a new flow of videography elements in the super-Digital landscape. We help brands find their creative core with strategic visual concepts and combine them with the right storytelling to inform, captivate, and inspire people. Our custom animated video production includes 2D and 3D animation, motion and comic videos.                    </p>
                  </div>
            ...
            <div className="max-w-7xl mx-auto px-8">
              ...
              <div className="text-center mb-16">
                <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6">
                  Video Animation <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Packages</span>
                </h2>
