              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    Leverage Feature-Packed{' '}
                      <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                      Mobile Technology.
                      </span>
                    </h2>
                    <p className="text-gray-300 text-lg leading-relaxed">
                    Scalability and performance is at the core of our development discipline as we tap into the full-scope of mobile app frameworks. We are focused on creating custom iOS and Android apps and cross-platform application platforms to complement or substitute web solutions with better user interface and experience.                 </p> </div>
