              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    Terraform your business idea into a functional and stellar website with a custom web domain in the digital olenix galaxy. Our web domain solutions are also designed for hosting services and supplement the cutting-edge digital technology for businesses to become competitive in their niche.
                    </p>
                  </div>
