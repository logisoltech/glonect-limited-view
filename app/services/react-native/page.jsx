              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    We aim for distinctive designs and intuitive functionalities with the versatile framework of React Native and give businesses a boost on their websites. Weberium has the technological edge to develop native, feature-packed, cross-platform apps and deliver greater user experiences.                    </p>
                  </div>
