                ...
                <div className="space-y-8">
                  <div>
                    <h2 className="text-white text-3xl lg:text-5xl font-bold leading-tight mb-6">
                      Outsmarting search engines for the{' '}
                      <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                        right results!
                      </span>
                    </h2>
                    <p className="text-gray-300 text-lg leading-relaxed">
                      Our seasoned marketing specialists are brainy and futuristic with their strategies that have stood 
                      the test of times across search engines. We are the leader in the marketing realm for businesses 
                      aiming for higher visibility, improved conversions, audits and optimization, and the right analytics 
                      with custom SEO services.
                    </p>
                  </div>
            ...
            <div className="max-w-7xl mx-auto px-8">
              ...
              <div className="text-center mb-16">
                <h2 className="text-4xl lg:text-6xl font-bold text-white mb-6">
                  SEO <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Packages</span>
                </h2>
                <p className="text-gray-300 text-xl max-w-3xl mx-auto">
                  Choose the perfect SEO package for your business needs. All packages come with our 100% satisfaction guarantee.
                </p>
              </div>
